  ...
  <div class="container">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav ms-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link" href="auth/loginUser.php"><h5>Login Karyawan</h5></a>
        </li>
        <li class="nav-item">
          <a class="nav-link" href="auth/loginAdmin.php"><h5>Admin</h5></a>
        </li>
      </ul>
    </div>
  </div>
    ...
    <div class="row">
      <div class="col-sm-8 mb-3">
        ...
        <div class="btnDaftar mt-5 mb-3">
          <a href="auth/loginUser.php" class="btn btn-primary"><b>Login Karyawan</b></a>
        </div>
    </div>
    
    <div class="col-sm-4 mb-3">
      <center><img class="person" src="assets/img/person.png" width="75%"></center>
    </div>
