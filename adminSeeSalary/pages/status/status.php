    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../../index.php">
                ...
                <div class="sidebar-brand-text mx-3">See$alary Status</div>
            </a>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                      <div class="container">
                        ...
                        <div class="mt-5 mb-5">
                            <button class="btn btn-primary" type="button" data-dismiss="modal">Tambah Status</button>
                            <br>
                            <br>
                          <table class="table">
                            <thead>
