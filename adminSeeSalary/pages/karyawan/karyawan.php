...
<head>
    ...
    <title>See$alary Karyawan</title>
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="../../index.php">
                ...
                <div class="sidebar-brand-text mx-3">See$alary Karyawan</div>
            </a>
            ...
            <li class="nav-item">
                <a class="nav-link" href="../jabatan/jabatan.php">
                <i class="fas fa-fw fa-chart-area"></i>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                      <div class="container">
                        ...
                        <div class="mt-5 mb-5">
                        <button class="btn btn-primary" type="button" data-dismiss="modal">Tambah Karyawan</button>
                        <br>
                        <br>
                          <table class="table">
                            <thead>
